...
import { initRenderer, renderScene, toggleThirdPerson } from './rendering.js';
...
function init() {
    const rendering = initRenderer(container);
    ...
    initWorld(scene, rendering.solidMaterial, rendering.transparentMaterial, rendering.waterMaterial);
